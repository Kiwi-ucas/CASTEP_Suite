...
Nineteen Fortran source files in `src/` (18 compiled, 1 uncompiled development artifact), plus a Rust subproject:
...
Standalone Bevy 0.15 3D application (12 source files):
